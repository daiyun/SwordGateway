...
public class PayloadEdit {
     ...
     * </pre>
     */
    private PayloadServerReload payloadServerReload;
    ...
    public PayloadServerReload getPayloadServerReload() {
        return payloadServerReload;
    }

    public void setPayloadServerReload(PayloadServerReload payloadServerReload) {
        this.payloadServerReload = payloadServerReload;
    }
